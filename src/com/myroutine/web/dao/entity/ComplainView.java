...
//public class ComplainView extends Complain{
...
public class ComplainView {
	 ...
	 * @param fileId
	 */
	public ComplainView(int commCount, int id, int writerId, String writerName, String title, int hit, Date regdate,
	...
	public String toString() {
		return "ComplainView [commCount=" + commCount + ", id=" + id + ", writerId=" + writerId + ", writerName="
