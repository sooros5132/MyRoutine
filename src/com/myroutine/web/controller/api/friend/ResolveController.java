...
public class ResolveController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( memberId_ == null || otherMemberId_ == null || state_ == null ||
			memberId_.equals("") || otherMemberId_.equals("") || state_.equals("")) {
		...
		result = service.update(memberId, otherMemberId, state);
